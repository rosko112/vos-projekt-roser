...
<html lang = "sl">
    ...
    <body>
        ...
        <div class="login">
            <h2 class="login-title">Rezervacija neuspešna</h2>
            <p>Žal vaša rezervacija ni bila uspešna. Prosim, poskusite znova.</p>
            <a href="index.php" class="submit-button">Nazaj na domačo stran</a>
        </div>
